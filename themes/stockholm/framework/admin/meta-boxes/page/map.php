...
$qodeGeneral = new QodeMetaBox("page", "Select General");
...
$qodeHeader = new QodeMetaBox("page", "Select Header","vertical_area",array("yes"));
...
$qodeTitle = new QodeMetaBox("page", "Select Title");
...
$qodeContentBottom = new QodeMetaBox("page", "Select Content Bottom");
...
$qodeBlog = new QodeMetaBox("page", "Select Blog");
...
$qodeSideBar = new QodeMetaBox("page", "Select Sidebar");
...
$qodeSeo = new QodeMetaBox("page", "Select SEO");
