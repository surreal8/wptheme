...
$qodeSlideType = new QodeMetaBox("slides", "Select Slide Type");
...
$qodeSlideImageSettings = new QodeMetaBox("slides", "Select Slide Image","qode_slide-background-type",array("video"));
...
$qodeSlideVideoSettings = new QodeMetaBox("slides", "Select Slide Video","qode_slide-background-type",array("image"));
...
$qodeSlideTitle = new QodeMetaBox("slides", "Select Slide Title","qode_slide-hide-title",array("yes"));
...
$qodeSlideGraphic = new QodeMetaBox("slides", "Select Slide Graphic");
...
$qodeSlideButtons = new QodeMetaBox("slides", "Select Slide Buttons");
