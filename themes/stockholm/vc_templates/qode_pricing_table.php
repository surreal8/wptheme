...
$html .= "<ul>";
$html .= "<li class='cell table_title' ".$title_holder_style."><span class='title_content' ".$title_style.">".$title."</span>";

$html .= "<li class='prices' style='".$pricing_table_background."'>";
...
$html .= "<li class='pricing_table_content' style='".$pricing_table_background."'>";
...
if(isset($button_text) && $button_text !== '') {
	...
	$html .= "<a ".$button_style." href='$link' target='$target'>".$button_text."</a>";
