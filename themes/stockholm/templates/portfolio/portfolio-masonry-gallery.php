	...
	if ($portfolio_m_images){
		...
		foreach($portfolio_image_gallery_array as $gimg_id){
			...
			<?php if($lightbox_single_project == "yes"){ ?>
				<a class="lightbox_single_portfolio mix <?php echo esc_attr($image_predefined_size); ?>" title="<?php echo $title; ?>" href="<?php echo $image_src; ?>" data-rel="prettyPhoto[single_pretty_photo]">
	...
	if (is_array($portfolio_images) && count($portfolio_images)){
		foreach($portfolio_images as $portfolio_image){
			...
			<?php if($portfolio_image['portfolioimg'] != ""){ ?>
				...
				<?php if($lightbox_single_project == "yes"){ ?>
					<a class="lightbox_single_portfolio mix <?php echo esc_attr($image_predefined_size); ?>" title="<?php echo $title; ?>" href="<?php echo stripslashes($portfolio_image['portfolioimg']); ?>" data-rel="prettyPhoto[single_pretty_photo]">
				...
				switch ($portfolio_video_type){
					case "youtube": ?>
						<?php if($lightbox_video_single_project == "yes"){ ?>
							...
							?>
							<a class="lightbox_single_portfolio mix" title="<?php echo $video_title; ?>" href="//www.youtube.com/watch?feature=player_embedded&v=<?php echo $vidID; ?>" data-rel="prettyPhoto[single_pretty_photo]">
					...
					case "vimeo": ?>
						<?php if($lightbox_video_single_project == "yes"){ ?>
							...
							?>
							<a class="lightbox_single_portfolio mix" title="<?php echo $video_title; ?>" href="<?php echo $protocol;?>//vimeo.com/<?php echo $portfolio_image['portfoliovideoid']; ?>" data-rel="prettyPhoto[single_pretty_photo]">
								<i class="fa fa-play"></i>
								<img width="100%" src="<?php echo $thumbnail; ?>"/>
							</a>
						<?php } else { ?>
