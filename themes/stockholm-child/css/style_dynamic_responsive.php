...
@media only screen and (max-width: 1000px){
	...
	.header_bottom {
		background-color: <?php echo $qode_options['header_background_color'];  ?>;
	}
	<?php } ?>
...
@media only screen and (min-width: 480px) and (max-width: 768px){
	...
	<?php if (isset($qode_options['parallax_minheight']) && !empty($qode_options['parallax_minheight'])) { ?>
        section.parallax_section_holder{
			...
			min-height: <?php echo $qode_options['parallax_minheight']; ?>px;
		}
	<?php } ?>
	
	<?php if (isset($qode_options['header_background_color_mobile']) &&  !empty($qode_options['header_background_color_mobile'])) { ?>
		header{
			 background-color: <?php echo $qode_options['header_background_color_mobile'];  ?> !important;
